...
$modelLabel = new \backend\models\IndexText();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'index-text-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('index-text/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "index-text-form", "class"=>"form-horizontal", "action"=>Url::toRoute("index-text/save")]); ?>                      
          ...
          <div id="name_div" class="form-group">
              ...
              <div class="col-sm-10">
				  <textarea name="IndexText[name]" cols="30" rows="5" id="name" placeholder="必填" class="form-control"></textarea>
              </div>
          ...
          <div id="order_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="order" name="IndexText[order]" placeholder="必填" />
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('index-text/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('index-text/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#index-text-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('index-text/create')?>" : "<?=Url::toRoute('index-text/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
